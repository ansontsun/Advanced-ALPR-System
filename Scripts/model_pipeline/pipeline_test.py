...
import scripts.model_pipeline.pipeline_helper as pipeline_helper
from scripts.model_pipeline.pipeline_helper import get_car, read_license_plate, write_csv

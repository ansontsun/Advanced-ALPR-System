...
pos_im_path = r"/content/gdrive/MyDrive/negative/flowers/daisy" # This is the path of our positive input dataset
# define the same for negatives
neg_im_path= r"/content/gdrive/MyDrive/positive/images"
...
image_size = (64, 128)  # Example size, adjust as needed
